## Working with Tables & Maps - Dash.plotly https://github.com/amyoshino/Dash_Tutorial_Series/blob/master/ex4.py
...
map_data = map_data[["Borough", "Type", "Provider", "Name",
    ...
    html.Div([
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.P('Developed by Adriano M. Yoshino - ',
                               style={'display': 'inline'}),
                        html.A('amyoshino@nyu.edu',
                               href='mailto:amyoshino@nyu.edu')
                    ], className="twelve columns",
